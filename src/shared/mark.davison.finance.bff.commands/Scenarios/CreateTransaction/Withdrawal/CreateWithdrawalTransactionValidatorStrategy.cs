...
public class CreateWithdrawalTransactionValidatorStrategy : ICreateTransactionValidatorStrategy
{
    ...
    public async Task ValidateTranasction(CreateTransactionDto transaction, CreateTransactionResponse response, ICreateTransctionValidationContext context)
    {
        ...
        // TODO: Base class
        var validDestinationIds = AccountConstants.Expenses.Concat(AccountConstants.Liabilities);
        ...
        // TODO: Base class
        var validSourceIds = AccountConstants.Assets.Concat(AccountConstants.Liabilities);
