namespace mark.davison.finance.models.configuration;
public static class NavigationPropertyEntityConfigurations
{
    public static void ConfigureEntity<TEntity>(EntityTypeBuilder<TEntity> builder) where TEntity : FinanceEntity
    {
        ...
        var entities = typeof(TEntity)
            .Assembly
            .DefinedTypes
            .Where(_ => _.BaseType == typeof(FinanceEntity))
            .Select(_ => _.Name)
            .ToList();
